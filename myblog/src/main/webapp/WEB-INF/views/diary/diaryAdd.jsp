		...
		<div class="container-fluid" id="pcont">
			<div class="page-head">
				...
				<ol class="breadcrumb">
					<li><a href="#">首页</a></li>
					<li><a href="#">日记管理</a></li>
					<li><a href="<%=basePath%>article/toArticleList">日记发布管理</a></li>
							...
							<div class="content">
								<form action = "<%=basePath%>article/addArticle" method = "post" class="form-horizontal" role="form" enctype="multipart/form-data" >
									...
									<div class="form-group">
										<label for="inputPassword3" class="col-sm-1 control-label">日记标题</label>
										<div class="col-sm-7">
									...
									<div class="form-group">
										<label for="inputPassword3" class="col-sm-1 control-label">日记图片</label>
										<div class="col-sm-7">
									...
									<div class="form-group">
										<label for="inputPassword3" class="col-sm-1 control-label">背景音乐</label>
										<div class="col-sm-7">
											 <input type="file" name="file"/><br>
										</div>
										<img id = "preview"/>
									...
									<div class="form-group">
										<label for="inputPassword3" class="col-sm-1 control-label">日记内容</label>
										<div class="col-sm-11">
