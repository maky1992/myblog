						...
						<div class="block-flat">
							...
							<div class="content">
								<form action = "<%=basePath%>article/addArticle" method = "post" class="form-horizontal" role="form" data-parsley-validate
									...
									<div class="form-group">
										<label for="inputPassword3" class="col-sm-1 control-label">博文关键字</label>
										<div class="col-sm-7">
									...
									<div class="form-group" >
										...
										<button id ="confirm" type="submit" class="btn btn-primary" onclick="return checkForm()">Confirm</button>
